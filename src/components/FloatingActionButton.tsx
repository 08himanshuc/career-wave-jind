...
const FloatingActionButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className={`flex flex-col gap-3 mb-4 transition-all duration-300 ${
        ...
        {contactOptions.map((option, index) => {
          ...
          return (
            <div
              key={option.label}
              className={`flex items-center gap-3 animate-fadeInUp ${option.delay}`}
            ...
            >
              ...
              <Button
                size="icon"
                className={`w-12 h-12 rounded-full ${option.color} text-white shadow-lg hover:scale-110 transition-all duration-200`}
      ...
      <Button
        size="icon"
        className={`w-14 h-14 rounded-full bg-primary hover:bg-primary/90 text-white shadow-lg hover:scale-110 transition-all duration-200 ${
